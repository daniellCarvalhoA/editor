...
typedef struct piece
{
    ...
    union
    {
        ...
        struct
        {
            ...
            // in  sequence. When rendering, we incur a lot of cache misses if the 
            // text correspoinding to the pieces is not layed out one after the other 
            // in their corresponding buffers.
            // If we were to inline the text in the pieces we would bypass the buffer 
            // indirection.
            //
            ...
            // => The inserted pieces will be inlined, copies must be made from 
            // the buffer referenced by the affected piece.
            ...
            //   => This would mean that to ascertain the type of the piece 
            //   (inlined vs non-inlined)
